...
class Enemytank0(Enemy):
    ...
    def shoot(self):
        self.gun.shoot()
    def update(self):
        if self.gun.time>=self.maxshootime and (not self.gun.ispre):
            self.gun.shoot()
        self.move()
        self.display()
...
def load():
    ...
    Light.images=[pygame.transform.smoothscale(load_image('2.png'),(1500,10)),pygame.transform.smoothscale(load_image('3.png'),(1500,10))]
    Shortlight.image=pygame.transform.smoothscale(load_image('shortlight.png'),(30,10))
    enShortlight.image=pygame.transform.smoothscale(load_image('shortlight.png'),(30,10))
        ...
        if self.addtime1>0:
            ...
            for i in range(self.addtime1):
                ...
                for e in self.allEnemy:                    
                    e.live+=5
                    e.maxshootime=e.maxshootime*0.92
